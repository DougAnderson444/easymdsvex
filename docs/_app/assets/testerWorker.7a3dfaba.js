import "https://cdn.jsdelivr.net/npm/mdsvex/dist/browser-es.js";
/*
  @license
	Rollup.js v2.71.1
...
class z {
  ...
  getEntities(e) {
    ...
    for (const s of e)
      t = t[s] = t[s] || Object.create(null, { [F$1]: { value: /* @__PURE__ */ new Set() } });
    return t[F$1];
  }
}
const W = new z();
class j {
  ...
  trackEntityAtPathAndGetIfTracked(e, t, s) {
    ...
    for (const t2 of e)
      i = i[t2] = i[t2] || Object.create(null, { [F$1]: { value: /* @__PURE__ */ new Map() } });
    const n = M(i[F$1], t, () => /* @__PURE__ */ new Set());
    return !!n.has(s) || (n.add(s), false);
  }
}
...
const $e = new class extends G {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return e.length !== 1 || je(Fe, e[0], t, s);
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return e.length !== 1 || je(ze, e[0], t, s);
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return e.length !== 1 || je(We, e[0], t, s);
  }
...
function je(e, t, s, i) {
  ...
  if (!e[t].callsArgs)
    return false;
  for (const n of e[t].callsArgs)
    if (s.args[n] && s.args[n].hasEffectsWhenCalledAtPath(O, { args: Ne, thisParam: null, withNew: false }, i))
      return true;
  return false;
}
function Ue(e, t) {
  return typeof t == "string" && e[t] ? e[t].returns : H;
}
const it = { Literal: [], Program: ["body"] };
class nt extends G {
  constructor(e, t, s) {
    super(), this.esTreeNode = e, this.keys = it[e.type] || function(e2) {
      return it[e2.type] = Object.keys(e2).filter((t2) => typeof e2[t2] == "object" && t2.charCodeAt(0) !== 95), it[e2.type];
...
class rt extends nt {
  ...
  hasEffects(e) {
    ...
    return this.argument.hasEffects(e) || t && (t === "always" || this.argument.hasEffectsWhenAccessedAtPath(V, e));
  }
  applyDeoptimizations() {
...
class at extends G {
  ...
  deoptimizeThisOnEventAtPath(e, t, s) {
    e === 2 && t.length === 0 && this.description.mutatesSelfAsArray && s.deoptimizePath(B);
  }
  getReturnExpressionWhenCalledAtPath(e, t) {
    return e.length > 0 ? H : this.description.returnsPrimitive || (this.description.returns === "self" ? t.thisParam || H : this.description.returns());
  }
  hasEffectsWhenAccessedAtPath(e) {
    return e.length > 1;
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    var i, n;
    if (e.length > 0 || this.description.mutatesSelfAsArray === true && ((i = t.thisParam) === null || i === void 0 ? void 0 : i.hasEffectsWhenAssignedAtPath(B, s)))
      return true;
    if (!this.description.callsArgs)
      return false;
    for (const e2 of this.description.callsArgs)
      if ((n = t.args[e2]) === null || n === void 0 ? void 0 : n.hasEffectsWhenCalledAtPath(O, { args: Ne, thisParam: null, withNew: false }, s))
        return true;
    return false;
  }
  includeCallArguments(e, t) {
...
class dt extends G {
  constructor(e, t, s = false) {
    if (super(), this.prototypeExpression = t, this.immutable = s, this.allProperties = [], this.deoptimizedPaths = /* @__PURE__ */ Object.create(null), this.expressionsToBeDeoptimizedByKey = /* @__PURE__ */ Object.create(null), this.gettersByKey = /* @__PURE__ */ Object.create(null), this.hasUnknownDeoptimizedInteger = false, this.hasUnknownDeoptimizedProperty = false, this.propertiesAndGettersByKey = /* @__PURE__ */ Object.create(null), this.propertiesAndSettersByKey = /* @__PURE__ */ Object.create(null), this.settersByKey = /* @__PURE__ */ Object.create(null), this.thisParametersToBeDeoptimized = /* @__PURE__ */ new Set(), this.unknownIntegerProps = [], this.unmatchableGetters = [], this.unmatchablePropertiesAndGetters = [], this.unmatchableSetters = [], Array.isArray(e))
  ...
  deoptimizePath(e) {
    ...
    if (e.length === 1) {
      if (typeof s != "string")
        return s === L ? this.deoptimizeIntegerProperties() : this.deoptimizeAllProperties();
    ...
    const i = e.length === 1 ? V : e.slice(1);
    for (const e2 of typeof s == "string" ? (this.propertiesAndGettersByKey[s] || this.unmatchablePropertiesAndGetters).concat(this.settersByKey[s] || this.unmatchableSetters) : this.allProperties)
      e2.deoptimizePath(i);
    (t = this.prototypeExpression) === null || t === void 0 || t.deoptimizePath(e.length === 1 ? [D, D] : e);
  }
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    var n;
    const [r, ...a] = t;
    if (this.hasUnknownDeoptimizedProperty || (e === 2 || t.length > 1) && typeof r == "string" && this.deoptimizedPaths[r])
      return void s.deoptimizePath(V);
    const [o, h, l] = e === 2 || t.length > 1 ? [this.propertiesAndGettersByKey, this.propertiesAndGettersByKey, this.unmatchablePropertiesAndGetters] : e === 0 ? [this.propertiesAndGettersByKey, this.gettersByKey, this.unmatchableGetters] : [this.propertiesAndSettersByKey, this.settersByKey, this.unmatchableSetters];
    if (typeof r == "string") {
      if (o[r]) {
        const t2 = h[r];
        if (t2)
          for (const n2 of t2)
            n2.deoptimizeThisOnEventAtPath(e, a, s, i);
        return void (this.immutable || this.thisParametersToBeDeoptimized.add(s));
      }
      for (const t2 of l)
        t2.deoptimizeThisOnEventAtPath(e, a, s, i);
      if (ut.test(r))
        for (const t2 of this.unknownIntegerProps)
          t2.deoptimizeThisOnEventAtPath(e, a, s, i);
    } else {
      for (const t2 of Object.values(h).concat([l]))
        for (const n2 of t2)
          n2.deoptimizeThisOnEventAtPath(e, a, s, i);
      for (const t2 of this.unknownIntegerProps)
        t2.deoptimizeThisOnEventAtPath(e, a, s, i);
    }
    this.immutable || this.thisParametersToBeDeoptimized.add(s), (n = this.prototypeExpression) === null || n === void 0 || n.deoptimizeThisOnEventAtPath(e, t, s, i);
  }
  getLiteralValueAtPath(e, t, s) {
    if (e.length === 0)
      return U$2;
    const i = e[0], n = this.getMemberExpressionAndTrackDeopt(i, s);
    return n ? n.getLiteralValueAtPath(e.slice(1), t, s) : this.prototypeExpression ? this.prototypeExpression.getLiteralValueAtPath(e, t, s) : e.length !== 1 ? U$2 : void 0;
  }
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    if (e.length === 0)
      return H;
    const n = e[0], r = this.getMemberExpressionAndTrackDeopt(n, i);
    return r ? r.getReturnExpressionWhenCalledAtPath(e.slice(1), t, s, i) : this.prototypeExpression ? this.prototypeExpression.getReturnExpressionWhenCalledAtPath(e, t, s, i) : H;
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    const [s, ...i] = e;
    if (e.length > 1) {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    const i = e[0], n = this.getMemberExpression(i);
  ...
  buildPropertyMaps(e) {
    const { allProperties: t, propertiesAndGettersByKey: s, propertiesAndSettersByKey: i, settersByKey: n, gettersByKey: r, unknownIntegerProps: a, unmatchablePropertiesAndGetters: o, unmatchableGetters: h, unmatchableSetters: l } = this, c = [];
    for (let u = e.length - 1; u >= 0; u--) {
      const { key: d, kind: p, property: f } = e[u];
      if (t.push(f), typeof d != "string") {
        if (d === L) {
          a.push(f);
          continue;
        }
        ...
        p === "set" ? i[d] || (i[d] = [f, ...c], n[d] = [f, ...l]) : p === "get" ? s[d] || (s[d] = [f, ...o], r[d] = [f, ...h]) : (i[d] || (i[d] = [f, ...c]), s[d] || (s[d] = [f, ...o]));
    }
  }
  ...
  getMemberExpression(e) {
    ...
    return (t == null ? void 0 : t.length) === 1 ? t[0] : t || this.unmatchablePropertiesAndGetters.length > 0 || this.unknownIntegerProps.length && ut.test(e) ? H : null;
  }
  getMemberExpressionAndTrackDeopt(e, t) {
    if (typeof e != "string")
      return H;
    const s = this.getMemberExpression(e);
    if (s !== H && !this.immutable) {
...
const pt = (e) => typeof e == "string" && /^\d+$/.test(e), ft = new class extends G {
  deoptimizeThisOnEventAtPath(e, t, s) {
    e !== 2 || t.length !== 1 || pt(t[0]) || s.deoptimizePath(V);
  }
...
class Nt extends q {
    ...
    if (!this.isReassigned && !this.deoptimizationTracker.trackEntityAtPathAndGetIfTracked(e, this))
      if (e.length === 0) {
        if (!this.isReassigned) {
          ...
          for (const t2 of e2)
            t2.deoptimizeCache();
          (t = this.init) === null || t === void 0 || t.deoptimizePath(V);
        }
      } else
  ...
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    if (this.isReassigned || !this.init)
      return s.deoptimizePath(V);
    i.withTrackedEntityAtPath(t, this.init, () => this.init.deoptimizeThisOnEventAtPath(e, t, s, i), void 0);
  }
  getLiteralValueAtPath(e, t, s) {
    return this.isReassigned || !this.init ? U$2 : t.withTrackedEntityAtPath(e, this.init, () => (this.expressionsToBeDeoptimized.push(s), this.init.getLiteralValueAtPath(e, t, s)), U$2);
  }
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    return this.isReassigned || !this.init ? H : s.withTrackedEntityAtPath(e, this.init, () => (this.expressionsToBeDeoptimized.push(i), this.init.getReturnExpressionWhenCalledAtPath(e, t, s, i)), H);
  }
  hasEffectsWhenAccessedAtPath(e, t) {
  ...
  hasEffectsWhenAssignedAtPath(e, t) {
    return !!this.included || e.length !== 0 && (!!this.isReassigned || this.init && !t.accessed.trackEntityAtPathAndGetIfTracked(e, this) && this.init.hasEffectsWhenAssignedAtPath(e, t));
  }
  hasEffectsWhenCalledAtPath(e, t, s) {
...
class Tt {
  ...
  addDeclaration(e, t, s, i) {
    ...
    return r ? r.addDeclaration(e, s) : (r = new Nt(e.name, e, s || $e, t), this.variables.set(n, r)), r;
  }
  contains(e) {
...
class Rt extends Tt {
  ...
  addAccessedGlobals(e, t) {
    ...
    for (const t2 of e)
      s.add(t2);
    t.set(this, s), this.parent instanceof Rt && this.parent.addAccessedGlobals(e, t);
  }
  ...
  deconflict(e, t, s) {
    ...
    for (const [e2, t2] of this.variables)
      (t2.included || t2.alwaysRendered) && t2.setRenderNames(null, $t(e2, i));
...
class Mt extends Rt {
  constructor(e, t) {
    super(e), this.parameters = [], this.hasRest = false, this.context = t, this.hoistedBodyVarScope = new Rt(this);
  }
  addParameterDeclaration(e) {
    const t = e.name;
    let s = this.hoistedBodyVarScope.variables.get(t);
    return s ? s.addDeclaration(e, null) : s = new Nt(t, e, H, this.context), this.variables.set(t, s), s;
  }
  ...
  includeCallArguments(e, t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const a = this.parameters[r] || n, o = t[r];
      if (a)
        if (s = false, a.length === 0)
          i = true;
        else
          for (const e2 of a)
            e2.included && (i = true), e2.calledFromTryStatement && (s = true);
      !i && o.shouldBeIncluded(e) && (i = true), i && o.include(e, s);
    }
  }
}
class Dt extends Mt {
...
function Bt(e, t, s = 0) {
  ...
  for (i = e.indexOf(t, s); ; ) {
    if ((s = e.indexOf("/", s)) === -1 || s >= i)
      return i;
    n = e.charCodeAt(++s), ++s, (s = n === 47 ? e.indexOf("\n", s) + 1 : e.indexOf("*/", s) + 2) > i && (i = e.indexOf(t, s));
  }
}
const Ft = /\S/g;
function zt(e, t) {
...
function jt(e, t, s, i, n) {
  ...
  c && (h = s + Wt(t.original.slice(s, l.start))[1]);
  for (let s2 = 1; s2 <= e.length; s2++)
    r = l, a = h, o = c, l = e[s2], c = l !== void 0 && (!l.included || l.needsBoundaries), o || c ? (h = r.end + Wt(t.original.slice(r.end, l === void 0 ? i : l.start))[1], r.included ? o ? r.render(t, n, { end: h, start: a }) : r.render(t, n) : Lt(r, t, a, h)) : r.render(t, n);
}
class Ht extends Rt {
  addDeclaration(e, t, s, i) {
    if (i) {
...
class Kt extends nt {
  ...
  render(e, t) {
    this.body.length ? jt(this.body, e, this.start + 1, this.end - 1, t) : super.render(e, t);
  }
}
function Xt(e, t) {
...
class ls extends nt {
  ...
  render(e, { snippets: { getPropertyAccess: t } }, { renderedParentType: s, isCalleeOfRenderedParent: i, isShorthandProperty: n } = X) {
    if (this.variable) {
      const r = this.variable.getName(t);
      r !== this.name && (e.overwrite(this.start, this.end, r, { contentOnly: true, storeName: true }), n && e.prependRight(this.start, `${this.name}: `)), r === "eval" && s === "CallExpression" && i && e.appendRight(this.start, "0, ");
    }
  }
  applyDeoptimizations() {
...
class us extends nt {
  ...
  declare(e, t) {
    return this.declarationInit = t, this.argument.declare(e, H);
  }
  deoptimizePath(e) {
    e.length === 0 && this.argument.deoptimizePath(O);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return e.length > 0 || this.argument.hasEffectsWhenAssignedAtPath(O, t);
  }
  markDeclarationReached() {
...
class ds extends nt {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    if (this.async) {
      ...
      if (t2.hasEffectsWhenCalledAtPath(["then"], { args: Ne, thisParam: null, withNew: false }, s) || e2 && (e2 === "always" || t2.hasEffectsWhenAccessedAtPath(["then"], s)))
        return true;
    }
    ...
    return s.ignore = { breaks: false, continues: false, labels: /* @__PURE__ */ new Set(), returnYield: true }, !!this.body.hasEffects(s) || (s.ignore = i, s.brokenFlow = n, false);
  }
  include(e, t) {
    this.included = true;
    for (const s2 of this.params)
      s2 instanceof ls || s2.include(e, t);
...
function ps(e, { exportNamesByVariable: t, snippets: { _: s, getObject: i, getPropertyAccess: n } }, r = "") {
  if (e.length === 1 && t.get(e[0]).length === 1) {
    const i2 = e[0];
    return `exports('${t.get(i2)}',${s}${i2.getName(n)}${r})`;
  }
  {
    const s2 = [];
    for (const i2 of e)
      for (const e2 of t.get(i2))
        s2.push([e2, i2.getName(n) + r]);
...
class xs extends Nt {
  ...
  applyThisDeoptimizationEvent(e, { event: t, path: s, thisParameter: i }) {
    e.deoptimizeThisOnEventAtPath(t, s, i === this ? e : i, W);
  }
  getInit(e) {
...
class bs extends Dt {
  constructor(e, t) {
    super(e, t), this.variables.set("arguments", this.argumentsVariable = new Es(t)), this.variables.set("this", this.thisVariable = new xs(t));
  }
  findLexicalBoundary() {
    return this;
  }
...
class vs extends nt {
  ...
  deoptimizeThisOnEventAtPath(e, t, s) {
    e === 2 && (t.length > 0 ? s.deoptimizePath(V) : this.scope.thisVariable.addEntityToBeDeoptimized(s));
  }
  getReturnExpressionWhenCalledAtPath(e) {
    return e.length !== 0 ? H : this.async ? (this.deoptimizedReturn || (this.deoptimizedReturn = true, this.scope.getReturnExpression().deoptimizePath(V), this.context.requestTreeshakingPass()), H) : this.scope.getReturnExpression();
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    s.replacedVariableInits.set(this.scope.thisVariable, t.withNew ? new dt(/* @__PURE__ */ Object.create(null), mt) : H);
    const { brokenFlow: n, ignore: r } = s;
    return s.ignore = { breaks: false, continues: false, labels: /* @__PURE__ */ new Set(), returnYield: true }, !!this.body.hasEffects(s) || (s.brokenFlow = n, i ? s.replacedVariableInits.set(this.scope.thisVariable, i) : s.replacedVariableInits.delete(this.scope.thisVariable), s.ignore = r, false);
  }
  include(e, t) {
    this.included = true, this.id && this.id.include();
    const s = this.scope.argumentsVariable.included;
    for (const i2 of this.params)
      i2 instanceof ls && !s || i2.include(e, t);
...
class Ns extends nt {
  ...
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    return e === 0 && this.kind === "get" && t.length === 0 || e === 1 && this.kind === "set" && t.length === 0 ? this.value.deoptimizeThisOnEventAtPath(2, O, s, i) : void this.getAccessedValue().deoptimizeThisOnEventAtPath(e, t, s, i);
  }
  getLiteralValueAtPath(e, t, s) {
  ...
  hasEffectsWhenAccessedAtPath(e, t) {
    return this.kind === "get" && e.length === 0 ? this.value.hasEffectsWhenCalledAtPath(O, this.accessorCallOptions, t) : this.getAccessedValue().hasEffectsWhenAccessedAtPath(e, t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return this.kind === "set" ? this.value.hasEffectsWhenCalledAtPath(O, this.accessorCallOptions, t) : this.getAccessedValue().hasEffectsWhenAssignedAtPath(e, t);
  }
  hasEffectsWhenCalledAtPath(e, t, s) {
...
class Ts extends nt {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return e.length === 0 ? !t.withNew || (this.classConstructor !== null ? this.classConstructor.hasEffectsWhenCalledAtPath(O, t, s) : this.superClass !== null && this.superClass.hasEffectsWhenCalledAtPath(e, t, s)) : this.getObjectEntity().hasEffectsWhenCalledAtPath(e, t, s);
  }
  include(e, t) {
    var s;
  ...
  getObjectEntity() {
    ...
    for (const s of this.body.body) {
      const i = s.static ? e : t, n = s.kind;
      if (i === t && !n)
        continue;
      const r = n === "set" || n === "get" ? n : "init";
      let a;
      if (s.computed) {
        const e2 = s.key.getLiteralValueAtPath(O, W, this);
        if (e2 === U$2) {
          i.push({ key: D, kind: r, property: s });
          continue;
        }
        a = String(e2);
      } else
        a = s.key instanceof ls ? s.key.name : String(s.key.value);
      i.push({ key: a, kind: r, property: s });
    }
    return e.unshift({ key: "prototype", kind: "init", property: new dt(t, this.superClass ? new $s(this.superClass, "prototype") : mt) }), this.objectEntity = new dt(e, this.superClass || mt);
  }
}
class Rs extends Ts {
  initialise() {
  ...
  render(e, t) {
    ...
    i === "system" && this.id && s.has(this.id.variable) && e.appendLeft(this.end, `${n}${ps([this.id.variable], t)};`), super.render(e, t);
  }
}
class Ds extends nt {
  hasEffects() {
...
class Os extends nt {
  ...
  render(e, t, s) {
    const { start: i, end: n } = s, r = function(e2, t2) {
      return zt(e2, Bt(e2, "default", t2) + 7);
    }(e.original, this.start);
    if (this.declaration instanceof Ls)
      this.renderNamedDeclaration(e, r, "function", "(", this.declaration.id === null, t);
    else if (this.declaration instanceof Rs)
      this.renderNamedDeclaration(e, r, "class", "{", this.declaration.id === null, t);
    else {
      if (this.variable.getOriginalVariable() !== this.variable)
        return void Lt(this, e, i, n);
      if (!this.variable.included)
        return e.remove(this.start, r), this.declaration.render(e, t, { renderedSurroundingElement: "ExpressionStatement" }), void (e.original[this.end - 1] !== ";" && e.appendLeft(this.end, ";"));
  ...
  renderNamedDeclaration(e, t, s, i, n, r) {
    ...
    e.remove(this.start, t), n && e.appendLeft(function(e2, t2, s2, i2) {
      const n2 = Bt(e2, t2, i2) + t2.length;
      e2 = e2.slice(n2, Bt(e2, s2, n2));
      const r2 = Bt(e2, "*");
      return r2 === -1 ? n2 : n2 + r2 + 1;
    }(e.original, s, i, t), ` ${l}`), o === "system" && this.declaration instanceof Rs && a.has(this.variable) && e.appendLeft(this.end, ` ${ps([this.variable], r)};`);
  }
  renderVariableDeclaration(e, t, { format: s, exportNamesByVariable: i, snippets: { cnst: n, getPropertyAccess: r } }) {
    const a = e.original.charCodeAt(this.end - 1) === 59, o = s === "system" && i.get(this.variable);
    o ? (e.overwrite(this.start, t, `${n} ${this.variable.getName(r)} = exports('${o[0]}', `), e.appendRight(a ? this.end - 1 : this.end, ")" + (a ? "" : ";"))) : (e.overwrite(this.start, t, `${n} ${this.variable.getName(r)} = `), a || e.appendLeft(this.end, ";"));
  }
}
...
class Vs extends nt {
  ...
  render(e, t, s) {
    ...
    this.declaration === null ? e.remove(i, n) : (e.remove(this.start, this.declaration.start), this.declaration.render(e, t, { end: n, start: i }));
  }
}
...
class vi extends nt {
  ...
  render(e, t, s) {
    if (this.consequent.length) {
      ...
      const i = this.test ? this.test.end : Bt(e.original, "default", this.start) + 7, n = Bt(e.original, ":", i) + 1;
      jt(this.consequent, e, n, s.end, t);
    } else
      super.render(e, t);
  }
}
...
class $i extends q {
  ...
  renderBlock(e) {
    const { exportNamesByVariable: t, format: s, freeze: i, indent: n, namespaceToStringTag: r, snippets: { _: a, cnst: o, getObject: h, getPropertyAccess: l, n: c, s: u } } = e, d = this.getMemberVariables(), p = Object.entries(d).map(([e2, t2]) => this.referencedEarly || t2.isReassigned ? [null, `get ${e2}${a}()${a}{${a}return ${t2.getName(l)}${u}${a}}`] : [e2, t2.getName(l)]);
    ...
    if (this.mergedNamespaces.length > 0) {
      ...
      r && (f = `/*#__PURE__*/Object.defineProperty(${f},${a}Symbol.toStringTag,${a}${oi(h)})`), i && (f = `/*#__PURE__*/Object.freeze(${f})`);
    return f = `${o} ${this.getName(l)}${a}=${a}${f};`, s === "system" && t.has(this) && (f += `${c}${ps([this], e)};`), f;
  }
  renderFirst() {
...
Cn.inherits = Tn, Cn.toArray = function(e, t) {
  if (Array.isArray(e))
    return e.slice();
  if (!e)
    return [];
  ...
  if (typeof e == "string")
    if (t) {
      ...
      for (var i = 0, n = 0; n < e.length; n++) {
        ...
        r < 128 ? s[i++] = r : r < 2048 ? (s[i++] = r >> 6 | 192, s[i++] = 63 & r | 128) : Rn(e, n) ? (r = 65536 + ((1023 & r) << 10) + (1023 & e.charCodeAt(++n)), s[i++] = r >> 18 | 240, s[i++] = r >> 12 & 63 | 128, s[i++] = r >> 6 & 63 | 128, s[i++] = 63 & r | 128) : (s[i++] = r >> 12 | 224, s[i++] = r >> 6 & 63 | 128, s[i++] = 63 & r | 128);
      }
  else
  ...
  for (var t = "", s = 0; s < e.length; s++)
    t += Dn(e[s].toString(16));
  return t;
}, Cn.htonl = Mn, Cn.toHex32 = function(e, t) {
  for (var s = "", i = 0; i < e.length; i++) {
    var n = e[i];
    t === "little" && (n = Mn(n)), s += Ln(n.toString(16));
  }
  return s;
}, Cn.zero2 = Dn, Cn.zero8 = Ln, Cn.join32 = function(e, t, s, i) {
  var n = s - t;
  $n(n % 4 == 0);
  for (var r = new Array(n / 4), a = 0, o = t; a < r.length; a++, o += 4) {
    var h;
    h = i === "big" ? e[o] << 24 | e[o + 1] << 16 | e[o + 2] << 8 | e[o + 3] : e[o + 3] << 24 | e[o + 2] << 16 | e[o + 1] << 8 | e[o], r[a] = h >>> 0;
  }
  return r;
}, Cn.split32 = function(e, t) {
  for (var s = new Array(4 * e.length), i = 0, n = 0; i < e.length; i++, n += 4) {
    var r = e[i];
    t === "big" ? (s[n] = r >>> 24, s[n + 1] = r >>> 16 & 255, s[n + 2] = r >>> 8 & 255, s[n + 3] = 255 & r) : (s[n + 3] = r >>> 24, s[n + 2] = r >>> 16 & 255, s[n + 1] = r >>> 8 & 255, s[n] = 255 & r);
  }
  return s;
}, Cn.rotr32 = function(e, t) {
  return e >>> t | e << 32 - t;
}, Cn.rotl32 = function(e, t) {
  return e << t | e >>> 32 - t;
}, Cn.sum32 = function(e, t) {
  return e + t >>> 0;
}, Cn.sum32_3 = function(e, t, s) {
  return e + t + s >>> 0;
}, Cn.sum32_4 = function(e, t, s, i) {
  return e + t + s + i >>> 0;
}, Cn.sum32_5 = function(e, t, s, i, n) {
  return e + t + s + i + n >>> 0;
}, Cn.sum64 = function(e, t, s, i) {
  var n = e[t], r = i + e[t + 1] >>> 0, a = (r < i ? 1 : 0) + s + n;
  e[t] = a >>> 0, e[t + 1] = r;
}, Cn.sum64_hi = function(e, t, s, i) {
  return (t + i >>> 0 < t ? 1 : 0) + e + s >>> 0;
}, Cn.sum64_lo = function(e, t, s, i) {
  return t + i >>> 0;
}, Cn.sum64_4_hi = function(e, t, s, i, n, r, a, o) {
  var h = 0, l = t;
  return h += (l = l + i >>> 0) < t ? 1 : 0, h += (l = l + r >>> 0) < r ? 1 : 0, e + s + n + a + (h += (l = l + o >>> 0) < o ? 1 : 0) >>> 0;
}, Cn.sum64_4_lo = function(e, t, s, i, n, r, a, o) {
  return t + i + r + o >>> 0;
}, Cn.sum64_5_hi = function(e, t, s, i, n, r, a, o, h, l) {
  var c = 0, u = t;
  return c += (u = u + i >>> 0) < t ? 1 : 0, c += (u = u + r >>> 0) < r ? 1 : 0, c += (u = u + o >>> 0) < o ? 1 : 0, e + s + n + a + h + (c += (u = u + l >>> 0) < l ? 1 : 0) >>> 0;
}, Cn.sum64_5_lo = function(e, t, s, i, n, r, a, o, h, l) {
  return t + i + r + o + l >>> 0;
}, Cn.rotr64_hi = function(e, t, s) {
  return (t << 32 - s | e >>> s) >>> 0;
}, Cn.rotr64_lo = function(e, t, s) {
  return (e << 32 - s | t >>> s) >>> 0;
}, Cn.shr64_hi = function(e, t, s) {
  return e >>> s;
}, Cn.shr64_lo = function(e, t, s) {
  return (e << 32 - s | t >>> s) >>> 0;
};
var On = {}, Vn = Cn, Bn = In;
function Fn() {
...
On.BlockHash = Fn, Fn.prototype.update = function(e, t) {
  if (e = Vn.toArray(e, t), this.pending ? this.pending = this.pending.concat(e) : this.pending = e, this.pendingTotal += e.length, this.pending.length >= this._delta8) {
    ...
    this.pending = e.slice(e.length - s, e.length), this.pending.length === 0 && (this.pending = null), e = Vn.join32(e, 0, e.length - s, this.endian);
  ...
  if (e <<= 3, this.endian === "big") {
    ...
    for (i[n++] = 255 & e, i[n++] = e >>> 8 & 255, i[n++] = e >>> 16 & 255, i[n++] = e >>> 24 & 255, i[n++] = 0, i[n++] = 0, i[n++] = 0, i[n++] = 0, r = 8; r < this.padLength; r++)
      i[n++] = 0;
  return i;
};
var zn = {}, Wn = Cn.rotr32;
...
zn.ft_1 = function(e, t, s, i) {
  return e === 0 ? jn(t, s, i) : e === 1 || e === 3 ? Gn(t, s, i) : e === 2 ? Un(t, s, i) : void 0;
...
Hn.inherits(or, rr);
or.blockSize = 512, or.outSize = 256, or.hmacStrength = 192, or.padLength = 64, or.prototype._update = function(e, t) {
  for (var s = this.W, i = 0; i < 16; i++)
    s[i] = e[t + i];
  for (; i < s.length; i++)
    s[i] = Qn(nr(s[i - 2]), s[i - 7], ir(s[i - 15]), s[i - 16]);
  var n = this.h[0], r = this.h[1], a = this.h[2], o = this.h[3], h = this.h[4], l = this.h[5], c = this.h[6], u = this.h[7];
  for (Xn(this.k.length === s.length), i = 0; i < s.length; i++) {
    var d = Zn(u, sr(h), Jn(h, l, c), this.k[i], s[i]), p = Yn(tr(n), er(n, r, a));
...
function na(e, t) {
  return e < 65 ? e === 36 : e < 91 || (e < 97 ? e === 95 : e < 123 || (e <= 65535 ? e >= 170 && ta.test(String.fromCharCode(e)) : t !== false && ia(e, Xr)));
}
function ra(e, t) {
  return e < 48 ? e === 36 : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? e === 95 : e < 123 || (e <= 65535 ? e >= 170 && sa.test(String.fromCharCode(e)) : t !== false && (ia(e, Xr) || ia(e, Kr)))));
}
var aa = function(e, t) {
...
function oa(e, t) {
  return new aa(e, { beforeExpr: true, binop: t });
}
var ha = { beforeExpr: true }, la = { startsExpr: true }, ca = {};
function ua(e, t) {
  return t === void 0 && (t = {}), t.keyword = e, ca[e] = new aa(e, t);
}
...
function ga(e, t, s) {
  ...
  for (var i = t; i < s; i++) {
    ...
    if (ma(n))
      return i < s - 1 && n === 13 && e.charCodeAt(i + 1) === 10 ? i + 2 : i + 1;
  }
  return -1;
}
var ya = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, Ea = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, xa = Object.prototype, ba = xa.hasOwnProperty, va = xa.toString, Aa = Object.hasOwn || function(e, t) {
  return ba.call(e, t);
...
function Ta(e) {
  var t = {};
  for (var s in _a)
    t[s] = e && Aa(e, s) ? e[s] : _a[s];
  if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!$a && typeof console == "object" && console.warn && ($a = true, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved == null && (t.allowReserved = t.ecmaVersion < 5), Sa(t.onToken)) {
    var i = t.onToken;
    t.onToken = function(e2) {
      return i.push(e2);
    };
  }
  return Sa(t.onComment) && (t.onComment = function(e2, t2) {
    return function(s2, i2, n, r, a, o) {
      var h = { type: s2 ? "Block" : "Line", value: i2, start: n, end: r };
      e2.locations && (h.loc = new Ia(this, a, o)), e2.ranges && (h.range = [n, r]), t2.push(h);
    };
  }(t, t.onComment)), t;
}
function Ra(e, t) {
...
Ma.prototype.parse = function() {
  ...
  for (var s = this, i = 0; i < e.length; i++)
    s = e[i](s);
  return s;
}, Ma.parse = function(e, t) {
  return new this(t, e).parse();
}, Ma.parseExpressionAt = function(e, t, s) {
  var i = new this(s, e, t);
  return i.nextToken(), i.parseExpression();
}, Ma.tokenizer = function(e, t) {
  return new this(t, e);
...
La.strictDirective = function(e) {
  ...
  for (; ; ) {
    ...
    if ((t[1] || t[2]) === "use strict") {
      Ea.lastIndex = e + t[0].length;
      var s = Ea.exec(this.input), i = s.index + s[0].length, n = this.input.charAt(i);
      return n === ";" || n === "}" || pa.test(s[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(n) || n === "!" && this.input.charAt(i + 1) === "=");
    }
    e += t[0].length, Ea.lastIndex = e, e += Ea.exec(this.input)[0].length, this.input[e] === ";" && e++;
  }
}, La.eat = function(e) {
...
}, La.afterTrailingComma = function(e, t) {
  if (this.type === e)
...
Ba.isLet = function(e) {
  ...
  var t = Ea.exec(this.input), s = this.pos + t[0].length, i = this.input.charCodeAt(s);
  ...
  if (i === 123)
    return true;
  if (na(i, true)) {
    for (var n = s + 1; ra(i = this.input.charCodeAt(n), true); )
      ++n;
  ...
  if (this.options.ecmaVersion < 8 || !this.isContextual("async"))
    return false;
  Ea.lastIndex = this.pos;
  var e, t = Ea.exec(this.input), s = this.pos + t[0].length;
  return !(pa.test(this.input.slice(this.pos, s)) || this.input.slice(s, s + 8) !== "function" || s + 8 !== this.input.length && (ra(e = this.input.charCodeAt(s + 8)) || e > 55295 && e < 56320));
}, Ba.parseStatement = function(e, t, s) {
  var i, n = this.type, r = this.startNode();
  switch (this.isLet(e) && (n = da._var, i = "let"), n) {
    case da._break:
    case da._continue:
    ...
    case da._const:
    case da._var:
      return i = i || this.value, e && i !== "var" && this.unexpected(), this.parseVarStatement(r, i);
    case da._while:
    ...
    case da._import:
      ...
      return this.options.allowImportExportEverywhere || (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'")), n === da._import ? this.parseImport(r) : this.parseExport(r, s);
    default:
...
}, Ba.parseBreakContinueStatement = function(e, t) {
  var s = t === "break";
  ...
  var s = this.isLet();
  if (this.type === da._var || this.type === da._const || s) {
    var i = this.startNode(), n = s ? "let" : this.value;
    return this.next(), this.parseVar(i, true, n), this.finishNode(i, "VariableDeclaration"), (this.type === da._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && i.declarations.length === 1 ? (this.options.ecmaVersion >= 9 && (this.type === da._in ? t > -1 && this.unexpected(t) : e.await = t > -1), this.parseForIn(e, i)) : (t > -1 && this.unexpected(t), this.parseFor(e, i));
  }
  var r = this.isContextual("let"), a = false, o = new Va(), h = this.parseExpression(!(t > -1) || "await", o);
...
}, Ba.parseFunctionStatement = function(e, t, s) {
  return this.next(), this.parseFunction(e, ja | (s ? 0 : Ua), false, t);
  ...
  for (var s = false; this.type !== da.braceR; )
    if (this.type === da._case || this.type === da._default) {
      var i = this.type === da._case;
      t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), i ? t.test = this.parseExpression() : (s && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), s = true, t.test = null), this.expect(da.colon);
    } else
...
Ba.parseTryStatement = function(e) {
  if (this.next(), e.block = this.parseBlock(), e.handler = null, this.type === da._catch) {
    ...
    if (this.next(), this.eat(da.parenL)) {
      ...
      this.enterScope(s ? 32 : 0), this.checkLValPattern(t.param, s ? 4 : 2), this.expect(da.parenR);
    } else
...
}, Ba.parseVarStatement = function(e, t) {
...
}, Ba.parseLabeledStatement = function(e, t, s, i) {
  ...
  return this.labels.push({ name: t, kind: a, statementStart: this.start }), e.body = this.parseStatement(i ? i.indexOf("label") === -1 ? i + "label" : i : "label"), this.labels.pop(), e.label = s, this.finishNode(e, "LabeledStatement");
}, Ba.parseExpressionStatement = function(e, t) {
  return e.expression = t, this.semicolon(), this.finishNode(e, "ExpressionStatement");
}, Ba.parseBlock = function(e, t, s) {
  for (e === void 0 && (e = true), t === void 0 && (t = this.startNode()), t.body = [], this.expect(da.braceL), e && this.enterScope(0); this.type !== da.braceR; ) {
    var i = this.parseStatement(null);
    t.body.push(i);
  }
  return s && (this.strict = false), this.next(), e && this.exitScope(), this.finishNode(t, "BlockStatement");
}, Ba.parseFor = function(e, t) {
  return e.init = t, this.expect(da.semi), e.test = this.type === da.semi ? null : this.parseExpression(), this.expect(da.semi), e.update = this.type === da.parenR ? null : this.parseExpression(), this.expect(da.parenR), e.body = this.parseStatement("for"), this.exitScope(), this.labels.pop(), this.finishNode(e, "ForStatement");
}, Ba.parseForIn = function(e, t) {
  var s = this.type === da._in;
...
}, Ba.parseVar = function(e, t, s) {
  for (e.declarations = [], e.kind = s; ; ) {
    var i = this.startNode();
    if (this.parseVarId(i, s), this.eat(da.eq) ? i.init = this.parseMaybeAssign(t) : s !== "const" || this.type === da._in || this.options.ecmaVersion >= 6 && this.isContextual("of") ? i.id.type === "Identifier" || t && (this.type === da._in || this.isContextual("of")) ? i.init = null : this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value") : this.unexpected(), e.declarations.push(this.finishNode(i, "VariableDeclarator")), !this.eat(da.comma))
      break;
  }
  return e;
}, Ba.parseVarId = function(e, t) {
  e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? 1 : 2, false);
};
var ja = 1, Ua = 2;
function Ga(e, t) {
  var s = t.key.name, i = e[s], n = "true";
  return t.type !== "MethodDefinition" || t.kind !== "get" && t.kind !== "set" || (n = (t.static ? "s" : "i") + t.kind), i === "iget" && n === "iset" || i === "iset" && n === "iget" || i === "sget" && n === "sset" || i === "sset" && n === "sget" ? (e[s] = "true", false) : !!i || (e[s] = n, false);
}
function Ha(e, t) {
  var s = e.computed, i = e.key;
  return !s && (i.type === "Identifier" && i.name === t || i.type === "Literal" && i.value === t);
}
Ba.parseFunction = function(e, t, s, i, n) {
  this.initFunction(e), (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !i) && (this.type === da.star && t & Ua && this.unexpected(), e.generator = this.eat(da.star)), this.options.ecmaVersion >= 8 && (e.async = !!i), t & ja && (e.id = 4 & t && this.type !== da.name ? null : this.parseIdent(), !e.id || t & Ua || this.checkLValSimple(e.id, this.strict || e.generator || e.async ? this.treatFunctionsAsVar ? 1 : 2 : 3));
  var r = this.yieldPos, a = this.awaitPos, o = this.awaitIdentPos;
  return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(Ra(e.async, e.generator)), t & ja || (e.id = this.type === da.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, s, false, n), this.yieldPos = r, this.awaitPos = a, this.awaitIdentPos = o, this.finishNode(e, t & ja ? "FunctionDeclaration" : "FunctionExpression");
...
}, Ba.parseClass = function(e, t) {
  this.next();
  var s = this.strict;
  this.strict = true, this.parseClassId(e, t), this.parseClassSuper(e);
  var i = this.enterClassBody(), n = this.startNode(), r = false;
  for (n.body = [], this.expect(da.braceL); this.type !== da.braceR; ) {
    var a = this.parseClassElement(e.superClass !== null);
    a && (n.body.push(a), a.type === "MethodDefinition" && a.kind === "constructor" ? (r && this.raise(a.start, "Duplicate constructor in the same class"), r = true) : a.key && a.key.type === "PrivateIdentifier" && Ga(i, a) && this.raiseRecoverable(a.key.start, "Identifier '#" + a.key.name + "' has already been declared"));
  }
  ...
  if (this.eat(da.semi))
    return null;
  var t = this.options.ecmaVersion, s = this.startNode(), i = "", n = false, r = false, a = "method", o = false;
  if (this.eatContextual("static")) {
    if (t >= 13 && this.eat(da.braceL))
      return this.parseClassStaticBlock(s), s;
    this.isClassElementNameStart() || this.type === da.star ? o = true : i = "static";
  }
  if (s.static = o, !i && t >= 8 && this.eatContextual("async") && (!this.isClassElementNameStart() && this.type !== da.star || this.canInsertSemicolon() ? i = "async" : r = true), !i && (t >= 9 || !r) && this.eat(da.star) && (n = true), !i && !r && !n) {
    var h = this.value;
    (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? a = h : i = h);
  }
  if (i ? (s.computed = false, s.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), s.key.name = i, this.finishNode(s.key, "Identifier")) : this.parseClassElementName(s), t < 13 || this.type === da.parenL || a !== "method" || n || r) {
    var l = !s.static && Ha(s, "constructor"), c = l && e;
    l && a !== "method" && this.raise(s.key.start, "Constructor can't have get/set modifier"), s.kind = l ? "constructor" : a, this.parseClassMethod(s, n, r, c);
  } else
...
}, Ba.parseClassMethod = function(e, t, s, i) {
  var n = e.key;
  e.kind === "constructor" ? (t && this.raise(n.start, "Constructor can't be a generator"), s && this.raise(n.start, "Constructor can't be an async method")) : e.static && Ha(e, "prototype") && this.raise(n.start, "Classes may not have a static property named prototype");
...
}, Ba.parseClassId = function(e, t) {
  this.type === da.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, false)) : (t === true && this.unexpected(), e.id = null);
  ...
  for (var e = this.privateNameStack.pop(), t = e.declared, s = e.used, i = this.privateNameStack.length, n = i === 0 ? null : this.privateNameStack[i - 1], r = 0; r < s.length; ++r) {
    var a = s[r];
    Aa(t, a.name) || (n ? n.used.push(a) : this.raiseRecoverable(a.start, "Private field '#" + a.name + "' must be declared in an enclosing class"));
  }
}, Ba.parseExport = function(e, t) {
  ...
  if (this.eat(da._default)) {
    var s;
    if (this.checkExport(t, "default", this.lastTokStart), this.type === da._function || (s = this.isAsyncFunction())) {
      var i = this.startNode();
...
}, Ba.checkExport = function(e, t, s) {
  e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), Aa(e, t) && this.raiseRecoverable(s, "Duplicate export '" + t + "'"), e[t] = true);
}, Ba.checkPatternExport = function(e, t) {
  var s = t.type;
  if (s === "Identifier")
...
}, Ba.checkVariableExport = function(e, t) {
  if (e)
  ...
  if (this.type === da.name) {
    ...
    if (s.local = this.parseIdent(), this.checkLValSimple(s.local, 2), e.push(this.finishNode(s, "ImportDefaultSpecifier")), !this.eat(da.comma))
      return e;
  }
...
var qa = Ma.prototype;
qa.toAssignable = function(e, t, s) {
...
}, qa.parseBindingList = function(e, t, s) {
  for (var i = [], n = true; !this.eat(e); )
    if (n ? n = false : this.expect(da.comma), t && this.type === da.comma)
      i.push(null);
    else {
      ...
      if (this.type === da.ellipsis) {
        ...
        this.parseBindingListItem(r), i.push(r), this.type === da.comma && this.raise(this.start, "Comma is not permitted after the rest element"), this.expect(e);
        break;
      }
  ...
  return e;
}, qa.parseMaybeDefault = function(e, t, s) {
  if (s = s || this.parseBindingAtom(), this.options.ecmaVersion < 6 || !this.eat(da.eq))
    return s;
  var i = this.startNodeAt(e, t);
  return i.left = s, i.right = this.parseMaybeAssign(), this.finishNode(i, "AssignmentPattern");
}, qa.checkLValSimple = function(e, t, s) {
  t === void 0 && (t = 0);
  var i = t !== 0;
  switch (e.type) {
    case "Identifier":
      this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (i ? "Binding " : "Assigning to ") + e.name + " in strict mode"), i && (t === 2 && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), s && (Aa(s, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), s[e.name] = true), t !== 5 && this.declareName(e.name, t, e.start));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
}, qa.checkLValPattern = function(e, t, s) {
...
}, qa.checkLValInnerPattern = function(e, t, s) {
  switch (t === void 0 && (t = 0), e.type) {
    case "Property":
...
Ya.initialContext = function() {
  ...
  return t === Xa.f_expr || t === Xa.f_stat || (e !== da.colon || t !== Xa.b_stat && t !== Xa.b_expr ? e === da._return || e === da.name && this.exprAllowed ? pa.test(this.input.slice(this.lastTokEnd, this.start)) : e === da._else || e === da.semi || e === da.eof || e === da.parenR || e === da.arrow || (e === da.braceL ? t === Xa.b_stat : e !== da._var && e !== da._const && e !== da.name && !this.exprAllowed) : !t.isExpr);
  ...
  var t, s = this.type;
  s.keyword && e === da.dot ? this.exprAllowed = false : (t = s.updateContext) ? t.call(this, e) : this.exprAllowed = s.beforeExpr;
  ...
  var t = e === da._if || e === da._for || e === da._with || e === da._while;
  ...
  var t = false;
  this.options.ecmaVersion >= 6 && e !== da.dot && (this.value === "of" && !this.exprAllowed || this.value === "yield" && this.inGeneratorContext()) && (t = true), this.exprAllowed = t;
};
var Qa = Ma.prototype;
function Za(e) {
  return e.type === "MemberExpression" && e.property.type === "PrivateIdentifier" || e.type === "ChainExpression" && Za(e.expression);
}
Qa.checkPropClash = function(e, t, s) {
  if (!(this.options.ecmaVersion >= 9 && e.type === "SpreadElement" || this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
    ...
    var r = e.kind;
    if (this.options.ecmaVersion >= 6)
      i === "__proto__" && r === "init" && (t.proto && (s ? s.doubleProto < 0 && (s.doubleProto = n.start) : this.raiseRecoverable(n.start, "Redefinition of __proto__ property")), t.proto = true);
    else {
      var a = t[i = "$" + i];
      if (a)
...
}, Qa.parseExpression = function(e, t) {
  var s = this.start, i = this.startLoc, n = this.parseMaybeAssign(e, t);
  ...
  return n;
}, Qa.parseMaybeAssign = function(e, t, s) {
  if (this.isContextual("yield")) {
    if (this.inGenerator)
      return this.parseYield(e);
    this.exprAllowed = false;
  }
  var i = false, n = -1, r = -1, a = -1;
  t ? (n = t.parenthesizedAssign, r = t.trailingComma, a = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new Va(), i = true);
  ...
  if (s && (l = s.call(this, l, o, h)), this.type.isAssign) {
    ...
    return c.operator = this.value, this.type === da.eq && (l = this.toAssignable(l, false, t)), i || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= l.start && (t.shorthandAssign = -1), this.type === da.eq ? this.checkLValPattern(l) : this.checkLValSimple(l), c.left = l, this.next(), c.right = this.parseMaybeAssign(e), a > -1 && (t.doubleProto = a), this.finishNode(c, "AssignmentExpression");
  }
  return i && this.checkExpressionErrors(t, true), n > -1 && (t.parenthesizedAssign = n), r > -1 && (t.trailingComma = r), l;
}, Qa.parseMaybeConditional = function(e, t) {
  var s = this.start, i = this.startLoc, n = this.parseExprOps(e, t);
  ...
  return n;
}, Qa.parseExprOps = function(e, t) {
  var s = this.start, i = this.startLoc, n = this.parseMaybeUnary(t, false, false, e);
  return this.checkExpressionErrors(t) || n.start === s && n.type === "ArrowFunctionExpression" ? n : this.parseExprOp(n, s, i, -1, e);
}, Qa.parseExprOp = function(e, t, s, i, n) {
  var r = this.type.binop;
  if (r != null && (!n || this.type !== da._in) && r > i) {
    var a = this.type === da.logicalOR || this.type === da.logicalAND, o = this.type === da.coalesce;
    o && (r = da.logicalAND.binop);
    var h = this.value;
    this.next();
    var l = this.start, c = this.startLoc, u = this.parseExprOp(this.parseMaybeUnary(null, false, false, n), l, c, r, n), d = this.buildBinary(t, s, e, u, h, a || o);
    return (a && this.type === da.coalesce || o && (this.type === da.logicalOR || this.type === da.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(d, t, s, i, n);
  }
  return e;
}, Qa.buildBinary = function(e, t, s, i, n, r) {
...
}, Qa.parseMaybeUnary = function(e, t, s, i) {
  var n, r = this.start, a = this.startLoc;
  if (this.isContextual("await") && this.canAwait)
    n = this.parseAwait(i), t = true;
  else if (this.type.prefix) {
    var o = this.startNode(), h = this.type === da.incDec;
    o.operator = this.value, o.prefix = true, this.next(), o.argument = this.parseMaybeUnary(null, true, h, i), this.checkExpressionErrors(e, true), h ? this.checkLValSimple(o.argument) : this.strict && o.operator === "delete" && o.argument.type === "Identifier" ? this.raiseRecoverable(o.start, "Deleting local variable in strict mode") : o.operator === "delete" && Za(o.argument) ? this.raiseRecoverable(o.start, "Private fields can not be deleted") : t = true, n = this.finishNode(o, h ? "UpdateExpression" : "UnaryExpression");
  } else if (t || this.type !== da.privateId) {
    ...
    (i || this.privateNameStack.length === 0) && this.unexpected(), n = this.parsePrivateIdent(), this.type !== da._in && this.unexpected();
  return s || !this.eat(da.starstar) ? n : t ? void this.unexpected(this.lastTokStart) : this.buildBinary(r, a, n, this.parseMaybeUnary(null, false, false, i), "**", false);
}, Qa.parseExprSubscripts = function(e, t) {
  var s = this.start, i = this.startLoc, n = this.parseExprAtom(e, t);
  if (n.type === "ArrowFunctionExpression" && this.input.slice(this.lastTokStart, this.lastTokEnd) !== ")")
    return n;
  var r = this.parseSubscripts(n, s, i, false, t);
...
}, Qa.parseSubscripts = function(e, t, s, i, n) {
  for (var r = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start == 5 && this.potentialArrowAt === e.start, a = false; ; ) {
    var o = this.parseSubscript(e, t, s, i, r, a, n);
...
}, Qa.parseSubscript = function(e, t, s, i, n, r, a) {
  ...
  if (l || h && this.type !== da.parenL && this.type !== da.backQuote || this.eat(da.dot)) {
    ...
    if (n && !h && !this.canInsertSemicolon() && this.eat(da.arrow))
      return this.checkPatternErrors(u, false), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = d, this.awaitPos = p, this.awaitIdentPos = f, this.parseArrowExpression(this.startNodeAt(t, s), m, true, a);
  ...
  switch (this.type) {
    ...
    case da.name:
      ...
      if (this.options.ecmaVersion >= 8 && !a && o.name === "async" && !this.canInsertSemicolon() && this.eat(da._function))
        return this.overrideContext(Xa.f_expr), this.parseFunction(this.startNodeAt(n, r), 0, false, true, t);
      if (i && !this.canInsertSemicolon()) {
        if (this.eat(da.arrow))
          return this.parseArrowExpression(this.startNodeAt(n, r), [o], false, t);
        if (this.options.ecmaVersion >= 8 && o.name === "async" && this.type === da.name && !a && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc))
          return o = this.parseIdent(false), !this.canInsertSemicolon() && this.eat(da.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, r), [o], true, t);
      }
      return o;
    case da.regexp:
      var h = this.value;
      return (s = this.parseLiteral(h.value)).regex = { pattern: h.pattern, flags: h.flags }, s;
    case da.num:
    case da.string:
    ...
    case da._true:
    case da._false:
      return (s = this.startNode()).value = this.type === da._null ? null : this.type === da._true, s.raw = this.type.keyword, this.next(), this.finishNode(s, "Literal");
    case da.parenL:
      var l = this.start, c = this.parseParenAndDistinguishExpression(i, t);
    ...
    case da.bracketL:
      return s = this.startNode(), this.next(), s.elements = this.parseExprList(da.bracketR, true, true, e), this.finishNode(s, "ArrayExpression");
    case da.braceL:
  ...
  if (this.next(), e.source = this.parseMaybeAssign(), !this.eat(da.parenR)) {
    var t = this.start;
    this.eat(da.comma) && this.eat(da.parenR) ? this.raiseRecoverable(t, "Trailing comma is not allowed in import()") : this.unexpected(t);
  }
...
}, Qa.parseParenAndDistinguishExpression = function(e, t) {
  var s, i = this.start, n = this.startLoc, r = this.options.ecmaVersion >= 8;
  if (this.options.ecmaVersion >= 6) {
    this.next();
    ...
    if (this.expect(da.parenR), e && !this.canInsertSemicolon() && this.eat(da.arrow))
      return this.checkPatternErrors(d, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = p, this.awaitPos = f, this.parseParenArrowList(i, n, l, t);
    l.length && !u || this.unexpected(this.lastTokStart), a && this.unexpected(a), this.checkExpressionErrors(d, true), this.yieldPos = p || this.yieldPos, this.awaitPos = f || this.awaitPos, l.length > 1 ? ((s = this.startNodeAt(o, h)).expressions = l, this.finishNodeAt(s, "SequenceExpression", m, g)) : s = l[0];
  } else
  ...
  return e;
}, Qa.parseParenArrowList = function(e, t, s, i) {
...
Qa.parseNew = function() {
  ...
  var i = this.start, n = this.startLoc, r = this.type === da._import;
  return e.callee = this.parseSubscripts(this.parseExprAtom(), i, n, true, false), r && e.callee.type === "ImportExpression" && this.raise(i, "Cannot use new with import()"), this.eat(da.parenL) ? e.arguments = this.parseExprList(da.parenR, this.options.ecmaVersion >= 8, false) : e.arguments = Ja, this.finishNode(e, "NewExpression");
}, Qa.parseTemplateElement = function(e) {
  var t = e.isTagged, s = this.startNode();
  return this.type === da.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), s.value = { raw: this.value, cooked: null }) : s.value = { raw: this.input.slice(this.start, this.end).replace(/\r\n?/g, "\n"), cooked: this.value }, this.next(), s.tail = this.type === da.backQuote, this.finishNode(s, "TemplateElement");
  ...
  for (s.quasis = [i]; !i.tail; )
    this.type === da.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(da.dollarBraceL), s.expressions.push(this.parseExpression()), this.expect(da.braceR), s.quasis.push(i = this.parseTemplateElement({ isTagged: t }));
...
}, Qa.parseObj = function(e, t) {
  var s = this.startNode(), i = true, n = {};
  for (s.properties = [], this.next(); !this.eat(da.braceR); ) {
    if (i)
      i = false;
...
}, Qa.parseProperty = function(e, t) {
  var s, i, n, r, a = this.startNode();
  if (this.options.ecmaVersion >= 9 && this.eat(da.ellipsis))
    return e ? (a.argument = this.parseIdent(false), this.type === da.comma && this.raise(this.start, "Comma is not permitted after the rest element"), this.finishNode(a, "RestElement")) : (this.type === da.parenL && t && (t.parenthesizedAssign < 0 && (t.parenthesizedAssign = this.start), t.parenthesizedBind < 0 && (t.parenthesizedBind = this.start)), a.argument = this.parseMaybeAssign(false, t), this.type === da.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(a, "SpreadElement"));
  this.options.ecmaVersion >= 6 && (a.method = false, a.shorthand = false, (e || t) && (n = this.start, r = this.startLoc), e || (s = this.eat(da.star)));
  var o = this.containsEsc;
  return this.parsePropertyName(a), !e && !o && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(a) ? (i = true, s = this.options.ecmaVersion >= 9 && this.eat(da.star), this.parsePropertyName(a, t)) : i = false, this.parsePropertyValue(a, e, s, i, n, r, t, o), this.finishNode(a, "Property");
}, Qa.parsePropertyValue = function(e, t, s, i, n, r, a, o) {
  if ((s || i) && this.type === da.colon && this.unexpected(), this.eat(da.colon))
    e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(false, a), e.kind = "init";
  ...
  else if (t || o || !(this.options.ecmaVersion >= 5) || e.computed || e.key.type !== "Identifier" || e.key.name !== "get" && e.key.name !== "set" || this.type === da.comma || this.type === da.braceR || this.type === da.eq)
    this.options.ecmaVersion >= 6 && !e.computed && e.key.type === "Identifier" ? ((s || i) && this.unexpected(), this.checkUnreserved(e.key), e.key.name !== "await" || this.awaitIdentPos || (this.awaitIdentPos = n), e.kind = "init", t ? e.value = this.parseMaybeDefault(n, r, this.copyNode(e.key)) : this.type === da.eq && a ? (a.shorthandAssign < 0 && (a.shorthandAssign = this.start), e.value = this.parseMaybeDefault(n, r, this.copyNode(e.key))) : e.value = this.copyNode(e.key), e.shorthand = true) : this.unexpected();
  else {
...
}, Qa.parseMethod = function(e, t, s) {
  var i = this.startNode(), n = this.yieldPos, r = this.awaitPos, a = this.awaitIdentPos;
  return this.initFunction(i), this.options.ecmaVersion >= 6 && (i.generator = e), this.options.ecmaVersion >= 8 && (i.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(64 | Ra(t, i.generator) | (s ? 128 : 0)), this.expect(da.parenL), i.params = this.parseBindingList(da.parenR, false, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(i, false, true, false), this.yieldPos = n, this.awaitPos = r, this.awaitIdentPos = a, this.finishNode(i, "FunctionExpression");
}, Qa.parseArrowExpression = function(e, t, s, i) {
  var n = this.yieldPos, r = this.awaitPos, a = this.awaitIdentPos;
  return this.enterScope(16 | Ra(s, false)), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!s), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, true), this.parseFunctionBody(e, true, false, i), this.yieldPos = n, this.awaitPos = r, this.awaitIdentPos = a, this.finishNode(e, "ArrowFunctionExpression");
}, Qa.parseFunctionBody = function(e, t, s, i) {
  var n = t && this.type !== da.braceL, r = this.strict, a = false;
  if (n)
    ...
    var h = this.labels;
    this.labels = [], a && (this.strict = true), this.checkParams(e, !r && !a && !t && !s && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, 5), e.body = this.parseBlock(false, void 0, a && !r), e.expression = false, this.adaptDirectivePrologue(e.body.body), this.labels = h;
  }
  this.exitScope();
  ...
  return true;
}, Qa.checkParams = function(e, t) {
  for (var s = /* @__PURE__ */ Object.create(null), i = 0, n = e.params; i < n.length; i += 1) {
    var r = n[i];
    this.checkLValInnerPattern(r, 1, t ? null : s);
  }
}, Qa.parseExprList = function(e, t, s, i) {
  for (var n = [], r = true; !this.eat(e); ) {
    if (r)
      r = false;
    else if (this.expect(da.comma), t && this.afterTrailingComma(e))
      break;
    var a = void 0;
    s && this.type === da.comma ? a = null : this.type === da.ellipsis ? (a = this.parseSpread(i), i && this.type === da.comma && i.trailingComma < 0 && (i.trailingComma = this.start)) : a = this.parseMaybeAssign(false, i), n.push(a);
  }
  return n;
...
}, Qa.parseIdent = function(e, t) {
  var s = this.startNode();
  return this.type === da.name ? s.name = this.value : this.type.keyword ? (s.name = this.type.keyword, s.name !== "class" && s.name !== "function" || this.lastTokEnd === this.lastTokStart + 1 && this.input.charCodeAt(this.lastTokStart) === 46 || this.context.pop()) : this.unexpected(), this.next(!!e), this.finishNode(s, "Identifier"), e || (this.checkUnreserved(s), s.name !== "await" || this.awaitIdentPos || (this.awaitIdentPos = s.start)), s;
  ...
  var t = this.startNode();
  return this.next(), this.type === da.semi || this.canInsertSemicolon() || this.type !== da.star && !this.type.startsExpr ? (t.delegate = false, t.argument = null) : (t.delegate = this.eat(da.star), t.argument = this.parseMaybeAssign(e)), this.finishNode(t, "YieldExpression");
...
var eo = Ma.prototype;
eo.raise = function(e, t) {
  var s = Na(this.input, e);
  t += " (" + s.line + ":" + s.column + ")";
...
var io = function(e, t, s) {
  this.type = "", this.start = t, this.end = 0, e.options.locations && (this.loc = new Ia(e, s)), e.options.directSourceFile && (this.sourceFile = e.options.directSourceFile), e.options.ranges && (this.range = [t, 0]);
}, no = Ma.prototype;
function ro(e, t, s, i) {
...
no.startNode = function() {
  ...
  return new io(this, e, t);
}, no.finishNode = function(e, t) {
  return ro.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
}, no.finishNodeAt = function(e, t, s, i) {
  return ro.call(this, e, t, s, i);
}, no.copyNode = function(e) {
  var t = new io(this, e.start, this.startLoc);
  for (var s in e)
    t[s] = e[s];
  return t;
};
...
function Eo(e) {
  var t = yo[e] = { binary: Pa(lo[e] + " " + co), nonBinary: { General_Category: Pa(co), Script: Pa(go[e]) } };
...
Ao.prototype.reset = function(e, t, s) {
  var i = s.indexOf("u") !== -1;
...
}, Ao.prototype.nextIndex = function(e, t) {
  t === void 0 && (t = false);
  var s = this.source, i = s.length;
  if (e >= i)
    return i;
  var n, r = s.charCodeAt(e);
  ...
  for (var t = e.validFlags, s = e.flags, i = 0; i < s.length; i++) {
    var n = s.charAt(i);
    t.indexOf(n) === -1 && this.raise(e.start, "Invalid regular expression flag"), s.indexOf(n, i + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag");
  }
...
}, vo.regexp_eatQuantifier = function(e, t) {
  return t === void 0 && (t = false), !!this.regexp_eatQuantifierPrefix(e, t) && (e.eat(63), true);
}, vo.regexp_eatQuantifierPrefix = function(e, t) {
  return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t);
}, vo.regexp_eatBracedQuantifier = function(e, t) {
  var s = e.pos;
  if (e.eat(123)) {
    var i = 0, n = -1;
  ...
  var t = e.current();
  return !!So(t) && (e.lastIntValue = t, e.advance(), true);
}, vo.regexp_eatPatternCharacters = function(e) {
  for (var t = e.pos, s = 0; (s = e.current()) !== -1 && !So(s); )
    e.advance();
  return e.pos !== t;
  ...
  var t = e.current();
  return !!Po(t) && (e.lastIntValue = t % 32, e.advance(), true);
}, vo.regexp_eatRegExpUnicodeEscapeSequence = function(e, t) {
  t === void 0 && (t = false);
  var s, i = e.pos, n = t || e.switchU;
  if (e.eat(117)) {
  ...
  return false;
}, vo.regexp_validateUnicodePropertyNameAndValue = function(e, t, s) {
  Aa(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"), e.unicodeProperties.nonBinary[t].test(s) || e.raise("Invalid property value");
}, vo.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
  e.unicodeProperties.binary.test(t) || e.raise("Invalid property name");
}, vo.regexp_eatUnicodePropertyName = function(e) {
  var t = 0;
  for (e.lastStringValue = ""; ko(t = e.current()); )
    e.lastStringValue += ka(t), e.advance();
  return e.lastStringValue !== "";
}, vo.regexp_eatUnicodePropertyValue = function(e) {
  var t = 0;
  for (e.lastStringValue = ""; wo(t = e.current()); )
    e.lastStringValue += ka(t), e.advance();
  return e.lastStringValue !== "";
  ...
  if (e.eat(92)) {
    ...
    if (e.switchU) {
      var s = e.current();
      (s === 99 || _o(s)) && e.raise("Invalid class escape"), e.raise("Invalid escape");
    }
    e.pos = t;
  }
  var i = e.current();
  ...
  var t = e.current();
  return !(!Co(t) && t !== 95) && (e.lastIntValue = t % 32, e.advance(), true);
  ...
  var t = e.pos, s = 0;
  for (e.lastIntValue = 0; Co(s = e.current()); )
    e.lastIntValue = 10 * e.lastIntValue + (s - 48), e.advance();
  return e.pos !== t;
}, vo.regexp_eatHexDigits = function(e) {
  var t = e.pos, s = 0;
  for (e.lastIntValue = 0; Io(s = e.current()); )
    e.lastIntValue = 16 * e.lastIntValue + No(s), e.advance();
  return e.pos !== t;
  ...
  var t = e.current();
  return _o(t) ? (e.lastIntValue = t - 48, e.advance(), true) : (e.lastIntValue = 0, false);
}, vo.regexp_eatFixedHexDigits = function(e, t) {
  var s = e.pos;
  e.lastIntValue = 0;
  for (var i = 0; i < t; ++i) {
    var n = e.current();
...
To.next = function(e) {
  ...
  return { next: function() {
    var t = e.getToken();
    return { done: t.type === da.eof, value: t };
  } };
  ...
  if (s === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = s + 2, this.options.locations)
    for (var i = void 0, n = t; (i = ga(this.input, n, this.pos)) > -1; )
  ...
  for (var t = this.pos, s = this.options.onComment && this.curPosition(), i = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !ma(i); )
  ...
  return this.options.ecmaVersion >= 6 && e === 46 && t === 46 ? (this.pos += 3, this.finishToken(da.ellipsis)) : (++this.pos, this.finishToken(da.dot));
  ...
  var t = this.input.charCodeAt(this.pos + 1), s = 1, i = e === 42 ? da.star : da.modulo;
  return this.options.ecmaVersion >= 7 && e === 42 && t === 42 && (++s, i = da.starstar, t = this.input.charCodeAt(this.pos + 2)), t === 61 ? this.finishOp(da.assign, s + 1) : this.finishOp(i, s);
  ...
  return t === 61 ? this.finishOp(da.assign, 2) : this.finishOp(e === 124 ? da.bitwiseOR : da.bitwiseAND, 1);
  ...
  var t = this.input.charCodeAt(this.pos + 1);
  return t === e ? t !== 45 || this.inModule || this.input.charCodeAt(this.pos + 2) !== 62 || this.lastTokEnd !== 0 && !pa.test(this.input.slice(this.lastTokEnd, this.pos)) ? this.finishOp(da.incDec, 2) : (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : t === 61 ? this.finishOp(da.assign, 2) : this.finishOp(da.plusMin, 1);
}, To.readToken_lt_gt = function(e) {
  var t = this.input.charCodeAt(this.pos + 1), s = 1;
  return t === e ? (s = e === 62 && this.input.charCodeAt(this.pos + 2) === 62 ? 3 : 2, this.input.charCodeAt(this.pos + s) === 61 ? this.finishOp(da.assign, s + 1) : this.finishOp(da.bitShift, s)) : t !== 33 || e !== 60 || this.inModule || this.input.charCodeAt(this.pos + 2) !== 45 || this.input.charCodeAt(this.pos + 3) !== 45 ? (t === 61 && (s = 2), this.finishOp(da.relational, s)) : (this.skipLineComment(4), this.skipSpace(), this.nextToken());
}, To.readToken_eq_excl = function(e) {
  var t = this.input.charCodeAt(this.pos + 1);
  return t === 61 ? this.finishOp(da.equality, this.input.charCodeAt(this.pos + 2) === 61 ? 3 : 2) : e === 61 && t === 62 && this.options.ecmaVersion >= 6 ? (this.pos += 2, this.finishToken(da.arrow)) : this.finishOp(e === 61 ? da.eq : da.prefix, 1);
  ...
  for (var e, t, s = this.pos; ; ) {
    ...
    if (pa.test(i) && this.raise(s, "Unterminated regular expression"), e)
      e = false;
    else {
      if (i === "[")
        t = true;
...
}, To.readInt = function(e, t, s) {
  for (var i = this.options.ecmaVersion >= 12 && t === void 0, n = s && this.input.charCodeAt(this.pos) === 48, r = this.pos, a = 0, o = 0, h = 0, l = t == null ? 1 / 0 : t; h < l; ++h, ++this.pos) {
  ...
  return i && o === 95 && this.raiseRecoverable(this.pos - 1, "Numeric separator is not allowed at the last of digits"), this.pos === r || t != null && this.pos - r !== t ? null : a;
}, To.readRadixNumber = function(e) {
  var t = this.pos;
  this.pos += 2;
  var s = this.readInt(e);
  return s == null && this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (s = Ro(this.input.slice(t, this.pos)), ++this.pos) : na(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(da.num, s);
  ...
  if (!s && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var n = Ro(this.input.slice(t, this.pos));
    return ++this.pos, na(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(da.num, n);
  }
  s && /[89]/.test(this.input.slice(t, this.pos)) && (s = false), i !== 46 || s || (++this.pos, this.readInt(10), i = this.input.charCodeAt(this.pos)), i !== 69 && i !== 101 || s || ((i = this.input.charCodeAt(++this.pos)) !== 43 && i !== 45 || ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), na(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
  var r, a = (r = this.input.slice(t, this.pos), s ? parseInt(r, 8) : parseFloat(r.replace(/_/g, "")));
  ...
  for (var t = "", s = ++this.pos; ; ) {
    ...
    if (i === e)
      break;
    i === 92 ? (t += this.input.slice(s, this.pos), t += this.readEscapedChar(false), s = this.pos) : i === 8232 || i === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (ma(i) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
  }
  return t += this.input.slice(s, this.pos++), this.finishToken(da.string, t);
};
var Mo = {};
To.tryReadTemplateToken = function() {
...
}, To.invalidStringToken = function(e, t) {
  ...
  for (var e = "", t = this.pos; ; ) {
    ...
    if (s === 96 || s === 36 && this.input.charCodeAt(this.pos + 1) === 123)
      return this.pos !== this.start || this.type !== da.template && this.type !== da.invalidTemplate ? (e += this.input.slice(t, this.pos), this.finishToken(da.template, e)) : s === 36 ? (this.pos += 2, this.finishToken(da.dollarBraceL)) : (++this.pos, this.finishToken(da.backQuote));
    if (s === 92)
  ...
  switch (++this.pos, t) {
    ...
    default:
      if (t >= 48 && t <= 55) {
        ...
        return n > 255 && (i = i.slice(0, -1), n = parseInt(i, 8)), this.pos += i.length - 1, t = this.input.charCodeAt(this.pos), i === "0" && t !== 56 && t !== 57 || !this.strict && !e || this.invalidStringToken(this.pos - 1 - i.length, e ? "Octal literal in template string" : "Octal literal in strict mode"), String.fromCharCode(n);
      }
      return ma(t) ? "" : String.fromCharCode(t);
  }
  ...
  for (var e = "", t = true, s = this.pos, i = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
    ...
    if (ra(n, i))
      ...
      (t ? na : ra)(a, i) || this.invalidStringToken(r, "Invalid Unicode escape"), e += ka(a), s = this.pos;
    }
    t = false;
  }
  return e + this.input.slice(s, this.pos);
}, To.readWord = function() {
  var e = this.readWord1(), t = da.name;
  return this.keywords.test(e) && (t = ca[e]), this.finishToken(t, e);
};
...
const get_comment_handlers = (comments, raw) => ({
  ...
  enter(node2) {
    ...
    while (comments[0] && comments[0].start < node2.start) {
      ...
      comment.value = comment.value.replace(re, (match, id2, at3, hash, value2) => {
        if (hash)
          return `#${value2}`;
        if (at3)
          return `@${value2}`;
...
function handle_error(str, err) {
  re.lastIndex = 0;
  str = str.replace(re, (m, i, at3, hash, name) => {
    if (at3)
      return `@${name}`;
    if (hash)
      return `#${name}`;
...
//# sourceMappingURL=testerWorker.8d991f64.js.map